/*
 * This Caterina bootloader has been modified to support 
 * the Atlas board by Khalid Alawadhi, Remal IoT - 2023
 */
...
const USB_Descriptor_String_t ProductString =
{
	...
	#elif DEVICE_PID == 0x9711
	.UnicodeString          = L"Remal IoT Atlas" 
	#else
...
const USB_Descriptor_String_t ManufNameString = 
{
	...
	#elif DEVICE_VID == 0x1971
	.UnicodeString			= L"Remal IoT"
	#else
