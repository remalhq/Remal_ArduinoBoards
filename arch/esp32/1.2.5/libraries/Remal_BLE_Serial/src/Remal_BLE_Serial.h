 ...
 * @author  Khalid Mansoor AlAwadhi (Khalid@remal.io), Remal IoT
 * @date    24 June 2023
 * 
 * @brief   This library allows you to use Shabakah (ESP32C3) as a BLE (Bluetooth Low Energy) Serial device (UART).
 ...
 * 
 *
 * Initial release v1 (24 June 2023):
 *  - Hello, World!
 *
 * Future Plans:
 *  - Reduce size of used flash memory (if possible)
 *  - Revise TX/RX characteristics naming
 */
