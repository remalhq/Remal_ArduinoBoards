 ...
 * @date    16 Mar 2025
 * 
 * @brief   This example demonstrates subscribing to the MQTT broker at "mqtt.remal.io" and listening for messages on the topic "remal/simplemqtt/example".
...
#define MQTT_TOPIC          "remal/simplemqtt/example"    // Topic to subscribe to
