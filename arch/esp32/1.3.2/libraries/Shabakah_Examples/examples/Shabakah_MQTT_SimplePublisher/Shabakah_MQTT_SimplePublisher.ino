 ...
 * @date    11 Mar 2025
 * 
 * @brief   This example demonstrates connecting to the MQTT broker at "mqtt.remal.io" and publishing messages to the topic "remal/ex/simplemqtt" 
 ...
 *          Connect to the broker and subscribe to the topic "remal/ex/simplemqtt" to view the messages.
 *          
...
#define PUBLISH_TOPIC       "remal/ex/simplemqtt"    // Topic to publish messages to
